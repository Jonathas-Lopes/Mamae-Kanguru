...
<body>
    <header>
        <nav class="#48beae">
            <div class="">
                <a class="logo"><img class="imagem-1" src="./img/2NomeBrancoCortado.png" alt="Logo"></a>
                <ul class="abas hide-on-med-and-down">
                    ...
                    <li class=""><a class="pesquisar" href="PHP/Moradores.php"><i class="material-icons">search</i></a>
                    </li>
                </ul>
                <ul class="abas mobile-menu hide-on-large-only">
                    <li class="menus"><a data-target="slide-out" class="sidenav-trigger triger-index" href="#"><i
