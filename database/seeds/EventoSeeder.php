...
class EventoSeeder extends Seeder
{
   ...
   public function run()
   {
    ...
    DB::table('eventos')->insert([
        ...
        'data' => '2020/12/06',
        'descricao_1' => 'Faremos um churrasco no domingo,  06/12, a partir das 12h00, como encerramento do ano no nosso condomínio. Teremos um Papai Noel para distribuir lembrancinhas para as crianças e recreadores.',
        'descricao_2' => 'O valor fica em R$60,00 por adulto e R$ 35 por criança. Por favor, confirme a sua presença até dia 1º de dezembro, dizendo quantos adultos e crianças irão comparecer.',
        'descricao_3' => 'Pague os convites para o síndico Sérgio Moura até dia 02/12 para providenciarmos as compras. Participem!',
        'foto' => null,
        'condominio_id'=> '1'
    ]);
    }
