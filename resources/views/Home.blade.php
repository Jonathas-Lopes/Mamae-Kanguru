    ...
    <section class="assuntos">
        ...
        <div id="mensagens">
            <article class="card">
                ...
                <h5>#ofereço</h5>
                @if (Auth::user()->admin == 0)
                    <a class="botaoresponder btn-floating btn waves-effect waves-light"><i class="material-icons">reply</i></a>
                @endif
                @if (Auth::user()->admin == 1)
                    <a class="botaoresponder btn waves-effect waves-light"><i class="material-icons">delete</i></a>
                @endif
            </article>
            <article class="card">
